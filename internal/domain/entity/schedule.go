...
type Schedule struct {
	BaseModel
	DecisionRuleID uuid.UUID            `gorm:"type:uuid;uniqueIndex:idx_rule_placement" json:"decisionRuleId"`
	DecisionRule   *DecisionRule        `gorm:"foreignKey:DecisionRuleID"                json:"decisionRule,omitempty"`
	PlacementID    uuid.UUID            `gorm:"type:uuid;uniqueIndex:idx_rule_placement" json:"placementId"`
